...
urlpatterns = [
    ...
    path('addcomment', add_comment, name="addcomm"),
    path('getcomment/<int:code>', get_comment, name="getcomm"),
    path('check/<str:user>', check, name="check"),
    path('validate/<str:user>', validate, name="val"),
